...
import io.cucumber.java.en.*;// all error gone because of testng & java  after putting the *
import smartTech.ny.basePage.NewParentClass;
import smartTech.ny.elementsPage.MasterPageFactory;

public class Functional_StepDef extends NewParentClass {
...
*/
//		pf.getLogin("kanizislam.st@gmail.com", "abcd1234");
